...
Take a look at the code in the editor. It uses an old and traditional technique based on a set of classical functions derived from POSIX systems – a bit ugly, but efficient and portable.
